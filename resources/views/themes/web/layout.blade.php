...
<html lang="en">
    <head>
        ...
        <title>OK COMPUTER - @yield('title')</title>
        ...
        <link type="text/css" href="{{ asset('assets_web/css/custom.css') }}?v=3" media="all" rel="stylesheet"/>
        
        <link href="https://fonts.googleapis.com/css?family=Open+Sans:200,300,400,400i,500,600,700%7CMerriweather:300,300i" rel="stylesheet">
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
        
        @yield("link")
        <link rel="stylesheet" href="{{ asset('plugins/lobibox/dist/css/lobibox.min.css') }}">
        <style>
            .container-okc {
                width: 75%;
                margin: auto;
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=G-5S8JXMZF8K"></script>
		<script>
		  window.dataLayer = window.dataLayer || [];
		  function gtag(){dataLayer.push(arguments);}
		  gtag('js', new Date());

		  gtag('config', 'G-5S8JXMZF8K');
		</script>
